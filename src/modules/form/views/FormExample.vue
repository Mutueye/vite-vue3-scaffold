<template>
  <Card>
    <div
      ...
      <router-link
        to="/forminteractive"
        class="no-underline h-56px border-b border-border-lighter px-space leading-56px text-size-16px font-bold color-text-regular transition cursor-pointer hover:(bg-bg-page) border-text-secondary color-text-primary)">
        表单交互细节范例(讨论稿)
      </router-link>
    </div>
